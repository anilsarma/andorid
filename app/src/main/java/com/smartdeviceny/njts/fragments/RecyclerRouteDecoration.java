...
public class RecyclerRouteDecoration extends RecyclerView.ItemDecoration {
    ...
    public RecyclerRouteDecoration(int headerHeight, boolean sticky, @NonNull SectionCallback sectionCallback) {
    ...
    private View inflateHeaderView(RecyclerView parent) {
        View view =  LayoutInflater.from(parent.getContext()).inflate(R.layout.route_section_header, parent, false);
        //headerOffset =  view.getMeasuredHeight();
        return view;
    }
    ...
    public interface SectionCallback {
        ...
        CharSequence getSectionDate(int position);
    }
}
